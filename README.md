...
If you are ready to go live check-out [where to host Telegram bot](https://github.com/python-telegram-bot/python-telegram-bot/wiki/Where-to-host-Telegram-Bots)  
